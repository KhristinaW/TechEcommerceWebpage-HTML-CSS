...
function displayProducts(){
    ...
    let html ='';
    //loop thorugh products array and create html for each
    for(let i=0; i<products.length;i++){
        ...
        html+= `
            ...
            <div class="product-footer">
                ...
                <div class="add-btn" onclick="addToCart(${product.id})">ADD TO CART</div>
            </div> 
...
//Find the product in an array - products
    ...
    } //End of products array of objects -- loop
